package _006CesionControlAlPlanificador;
 ...
 * pausa cada vez que se produce un decremento en dicho contador. Además, en cada decremento cede el 
 * control al planificador de hilos
...
public class Hilo extends Thread {
    ...
    */
     ...
     * 4. Cede el control al planificador de hilos
    */
    @Override
    public void run() {
        while (cont >= 0) {
